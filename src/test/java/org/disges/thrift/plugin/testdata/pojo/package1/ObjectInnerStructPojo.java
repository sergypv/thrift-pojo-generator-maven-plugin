...
public class ObjectInnerStructPojo implements java.io.Serializable {
	...
	private org.disges.thrift.plugin.testdata.pojo.package1.SimpleStructPojo innerStruct;
	private org.disges.thrift.plugin.testdata.pojo.package2.SimpleStructPackage2Pojo innerStructPackage2;

	public ObjectInnerStructPojo() {
		super();
	}

	public ObjectInnerStructPojo(java.lang.String stringVariable,org.disges.thrift.plugin.testdata.pojo.package1.SimpleStructPojo innerStruct,org.disges.thrift.plugin.testdata.pojo.package2.SimpleStructPackage2Pojo innerStructPackage2) {
		super();
	...
	public org.disges.thrift.plugin.testdata.pojo.package1.SimpleStructPojo getInnerStruct() {
	       return innerStruct;
	}
	public void setInnerStruct(org.disges.thrift.plugin.testdata.pojo.package1.SimpleStructPojo innerStruct) {
	       this.innerStruct = innerStruct;
	}
	public org.disges.thrift.plugin.testdata.pojo.package2.SimpleStructPackage2Pojo getInnerStructPackage2() {
	       return innerStructPackage2;
	}
	public void setInnerStructPackage2(org.disges.thrift.plugin.testdata.pojo.package2.SimpleStructPackage2Pojo innerStructPackage2) {
	       this.innerStructPackage2 = innerStructPackage2;
	}
