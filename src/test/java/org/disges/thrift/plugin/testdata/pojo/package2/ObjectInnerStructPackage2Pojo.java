...
public class ObjectInnerStructPackage2Pojo implements java.io.Serializable {
	...
	private org.disges.thrift.plugin.testdata.pojo.package2.SimpleStructPackage2Pojo innerStruct;

	public ObjectInnerStructPackage2Pojo() {
		super();
	}

	public ObjectInnerStructPackage2Pojo(java.lang.String stringVariable,org.disges.thrift.plugin.testdata.pojo.package2.SimpleStructPackage2Pojo innerStruct) {
		super();
	...
	public org.disges.thrift.plugin.testdata.pojo.package2.SimpleStructPackage2Pojo getInnerStruct() {
	       return innerStruct;
	}
	public void setInnerStruct(org.disges.thrift.plugin.testdata.pojo.package2.SimpleStructPackage2Pojo innerStruct) {
	       this.innerStruct = innerStruct;
	}
