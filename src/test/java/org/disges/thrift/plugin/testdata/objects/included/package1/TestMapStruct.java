...
public class TestMapStruct implements org.apache.thrift.TBase<TestMapStruct, TestMapStruct._Fields>, java.io.Serializable, Cloneable {
  ...
  public Map<org.disges.thrift.plugin.testdata.objects.included.package2.SimpleStructPackage2,Integer> refOtherPackage; // required
  ...
  public TestMapStruct(
    ...
    Map<org.disges.thrift.plugin.testdata.objects.included.package2.SimpleStructPackage2,Integer> refOtherPackage)
  {
    this();
    this.refMap = refMap;
  ...
  public TestMapStruct(TestMapStruct other) {
    ...
    if (other.isSetRefOtherPackage()) {
      Map<org.disges.thrift.plugin.testdata.objects.included.package2.SimpleStructPackage2,Integer> __this__refOtherPackage = new HashMap<org.disges.thrift.plugin.testdata.objects.included.package2.SimpleStructPackage2,Integer>();
      for (Map.Entry<org.disges.thrift.plugin.testdata.objects.included.package2.SimpleStructPackage2, Integer> other_element : other.refOtherPackage.entrySet()) {

        org.disges.thrift.plugin.testdata.objects.included.package2.SimpleStructPackage2 other_element_key = other_element.getKey();
        Integer other_element_value = other_element.getValue();

        org.disges.thrift.plugin.testdata.objects.included.package2.SimpleStructPackage2 __this__refOtherPackage_copy_key = new org.disges.thrift.plugin.testdata.objects.included.package2.SimpleStructPackage2(other_element_key);
  ...
  public void putToRefOtherPackage(org.disges.thrift.plugin.testdata.objects.included.package2.SimpleStructPackage2 key, int val) {
    if (this.refOtherPackage == null) {
      this.refOtherPackage = new HashMap<org.disges.thrift.plugin.testdata.objects.included.package2.SimpleStructPackage2,Integer>();
    }
    this.refOtherPackage.put(key, val);
  }

  public Map<org.disges.thrift.plugin.testdata.objects.included.package2.SimpleStructPackage2,Integer> getRefOtherPackage() {
    return this.refOtherPackage;
  }

  public TestMapStruct setRefOtherPackage(Map<org.disges.thrift.plugin.testdata.objects.included.package2.SimpleStructPackage2,Integer> refOtherPackage) {
    this.refOtherPackage = refOtherPackage;
    return this;
  }
  ...
  public void setFieldValue(_Fields field, Object value) {
    ...
    case REF_OTHER_PACKAGE:
      if (value == null) {
        ...
        setRefOtherPackage((Map<org.disges.thrift.plugin.testdata.objects.included.package2.SimpleStructPackage2,Integer>)value);
      }
      break;
            ...
            if (schemeField.type == org.apache.thrift.protocol.TType.MAP) {
              {
                ...
                struct.refOtherPackage = new HashMap<org.disges.thrift.plugin.testdata.objects.included.package2.SimpleStructPackage2,Integer>(2*_map16.size);
                for (int _i17 = 0; _i17 < _map16.size; ++_i17)
                {
                  org.disges.thrift.plugin.testdata.objects.included.package2.SimpleStructPackage2 _key18; // required
                  int _val19; // required
                  _key18 = new org.disges.thrift.plugin.testdata.objects.included.package2.SimpleStructPackage2();
                  _key18.read(iprot);
    ...
    public void write(org.apache.thrift.protocol.TProtocol oprot, TestMapStruct struct) throws org.apache.thrift.TException {
      ...
      if (struct.refOtherPackage != null) {
        oprot.writeFieldBegin(REF_OTHER_PACKAGE_FIELD_DESC);
        {
          ...
          for (Map.Entry<org.disges.thrift.plugin.testdata.objects.included.package2.SimpleStructPackage2, Integer> _iter24 : struct.refOtherPackage.entrySet())
          {
  ...
  private static class TestMapStructTupleScheme extends TupleScheme<TestMapStruct> {
    ...
    public void write(org.apache.thrift.protocol.TProtocol prot, TestMapStruct struct) throws org.apache.thrift.TException {
      ...
      }
      {
        ...
        for (Map.Entry<org.disges.thrift.plugin.testdata.objects.included.package2.SimpleStructPackage2, Integer> _iter29 : struct.refOtherPackage.entrySet())
        {
    ...
    public void read(org.apache.thrift.protocol.TProtocol prot, TestMapStruct struct) throws org.apache.thrift.TException {
      ...
      struct.setSimpleMapIsSet(true);
      {
        ...
        struct.refOtherPackage = new HashMap<org.disges.thrift.plugin.testdata.objects.included.package2.SimpleStructPackage2,Integer>(2*_map46.size);
        for (int _i47 = 0; _i47 < _map46.size; ++_i47)
        {
          org.disges.thrift.plugin.testdata.objects.included.package2.SimpleStructPackage2 _key48; // required
          int _val49; // required
          _key48 = new org.disges.thrift.plugin.testdata.objects.included.package2.SimpleStructPackage2();
          _key48.read(iprot);
