...
public class TestTypesStructPojo implements java.io.Serializable {
	...
	private org.disges.thrift.plugin.testdata.pojo.package1.EnumStructPojo enumType;
	private org.disges.thrift.plugin.testdata.pojo.package1.SimpleStructPojo ref;
	private org.disges.thrift.plugin.testdata.pojo.package1.ObjectInnerStructPojo composedStruct;

	public TestTypesStructPojo() {
		super();
	}

	public TestTypesStructPojo(java.lang.String simpleString,java.lang.String nonRequiredString,short number16b,int number32b,long number64b,boolean booleanValue,byte byteValue,double doubleValue,org.disges.thrift.plugin.testdata.pojo.package1.EnumStructPojo enumType,org.disges.thrift.plugin.testdata.pojo.package1.SimpleStructPojo ref,org.disges.thrift.plugin.testdata.pojo.package1.ObjectInnerStructPojo composedStruct) {
		super();
	...
	public org.disges.thrift.plugin.testdata.pojo.package1.EnumStructPojo getEnumType() {
	       return enumType;
	}
	public void setEnumType(org.disges.thrift.plugin.testdata.pojo.package1.EnumStructPojo enumType) {
	       this.enumType = enumType;
	}
	public org.disges.thrift.plugin.testdata.pojo.package1.SimpleStructPojo getRef() {
	       return ref;
	}
	public void setRef(org.disges.thrift.plugin.testdata.pojo.package1.SimpleStructPojo ref) {
	       this.ref = ref;
	}
	public org.disges.thrift.plugin.testdata.pojo.package1.ObjectInnerStructPojo getComposedStruct() {
	       return composedStruct;
	}
	public void setComposedStruct(org.disges.thrift.plugin.testdata.pojo.package1.ObjectInnerStructPojo composedStruct) {
	       this.composedStruct = composedStruct;
	}
