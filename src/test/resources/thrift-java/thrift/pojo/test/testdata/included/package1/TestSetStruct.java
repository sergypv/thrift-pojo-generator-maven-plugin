...
public class TestSetStruct implements org.apache.thrift.TBase<TestSetStruct, TestSetStruct._Fields>, java.io.Serializable, Cloneable {
  ...
  public Set<thrift.pojo.test.testdata.included.package2.SimpleStructPackage2> refOtherPackageList; // required
  ...
  public TestSetStruct(
    ...
    Set<thrift.pojo.test.testdata.included.package2.SimpleStructPackage2> refOtherPackageList)
  {
    this();
  ...
  public TestSetStruct(TestSetStruct other) {
    ...
    if (other.isSetRefOtherPackageList()) {
      Set<thrift.pojo.test.testdata.included.package2.SimpleStructPackage2> __this__refOtherPackageList = new HashSet<thrift.pojo.test.testdata.included.package2.SimpleStructPackage2>();
  ...
  public void addToRefOtherPackageList(thrift.pojo.test.testdata.included.package2.SimpleStructPackage2 elem) {
    if (this.refOtherPackageList == null) {
      this.refOtherPackageList = new HashSet<thrift.pojo.test.testdata.included.package2.SimpleStructPackage2>();
    }
    this.refOtherPackageList.add(elem);
  }

  public Set<thrift.pojo.test.testdata.included.package2.SimpleStructPackage2> getRefOtherPackageList() {
    return this.refOtherPackageList;
  }

  public TestSetStruct setRefOtherPackageList(Set<thrift.pojo.test.testdata.included.package2.SimpleStructPackage2> refOtherPackageList) {
    this.refOtherPackageList = refOtherPackageList;
    return this;
  }
  ...
  public void setFieldValue(_Fields field, Object value) {
    ...
    case REF_OTHER_PACKAGE_LIST:
      if (value == null) {
        ...
        setRefOtherPackageList((Set<thrift.pojo.test.testdata.included.package2.SimpleStructPackage2>)value);
      }
      break;
            ...
            if (schemeField.type == org.apache.thrift.protocol.TType.SET) {
              {
                ...
                struct.refOtherPackageList = new HashSet<thrift.pojo.test.testdata.included.package2.SimpleStructPackage2>(2*_set80.size);
                for (int _i81 = 0; _i81 < _set80.size; ++_i81)
                {
                  thrift.pojo.test.testdata.included.package2.SimpleStructPackage2 _elem82; // required
                  _elem82 = new thrift.pojo.test.testdata.included.package2.SimpleStructPackage2();
                  _elem82.read(iprot);
    ...
    public void write(org.apache.thrift.protocol.TProtocol oprot, TestSetStruct struct) throws org.apache.thrift.TException {
      ...
      if (struct.refOtherPackageList != null) {
        oprot.writeFieldBegin(REF_OTHER_PACKAGE_LIST_FIELD_DESC);
        {
          ...
          for (thrift.pojo.test.testdata.included.package2.SimpleStructPackage2 _iter85 : struct.refOtherPackageList)
          {
            _iter85.write(oprot);
          }
          oprot.writeSetEnd();
  ...
  private static class TestSetStructTupleScheme extends TupleScheme<TestSetStruct> {
    ...
    public void write(org.apache.thrift.protocol.TProtocol prot, TestSetStruct struct) throws org.apache.thrift.TException {
      ...
      }
      {
        ...
        for (thrift.pojo.test.testdata.included.package2.SimpleStructPackage2 _iter88 : struct.refOtherPackageList)
        {
          _iter88.write(oprot);
        }
      }
    ...
    public void read(org.apache.thrift.protocol.TProtocol prot, TestSetStruct struct) throws org.apache.thrift.TException {
      ...
      struct.setRefListIsSet(true);
      {
        ...
        struct.refOtherPackageList = new HashSet<thrift.pojo.test.testdata.included.package2.SimpleStructPackage2>(2*_set95.size);
        for (int _i96 = 0; _i96 < _set95.size; ++_i96)
        {
          thrift.pojo.test.testdata.included.package2.SimpleStructPackage2 _elem97; // required
          _elem97 = new thrift.pojo.test.testdata.included.package2.SimpleStructPackage2();
          _elem97.read(iprot);
