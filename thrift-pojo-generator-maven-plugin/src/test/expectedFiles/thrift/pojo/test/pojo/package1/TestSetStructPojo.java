...
public class TestSetStructPojo implements java.io.Serializable {
	...
	private java.util.Set<thrift.pojo.test.pojo.package1.SimpleStructPojo> refList;
	private java.util.Set<thrift.pojo.test.pojo.package2.SimpleStructPackage2Pojo> refOtherPackageList;

	public TestSetStructPojo() {
		super();
	}

	public TestSetStructPojo(java.util.Set<java.lang.Integer> simpleList,java.util.Set<thrift.pojo.test.pojo.package1.SimpleStructPojo> refList,java.util.Set<thrift.pojo.test.pojo.package2.SimpleStructPackage2Pojo> refOtherPackageList) {
		super();
	...
	public java.util.Set<thrift.pojo.test.pojo.package1.SimpleStructPojo> getRefList() {
	       return refList;
	}
	public void setRefList(java.util.Set<thrift.pojo.test.pojo.package1.SimpleStructPojo> refList) {
	       this.refList = refList;
	}
	public java.util.Set<thrift.pojo.test.pojo.package2.SimpleStructPackage2Pojo> getRefOtherPackageList() {
	       return refOtherPackageList;
	}
	public void setRefOtherPackageList(java.util.Set<thrift.pojo.test.pojo.package2.SimpleStructPackage2Pojo> refOtherPackageList) {
	       this.refOtherPackageList = refOtherPackageList;
	}
